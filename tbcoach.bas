...
Center 1, STRING$(80, " ")
Center 25, STRING$(80, " ")
Center 1, "Toxic Brain Coach 1.7ß"
LoadUser
inreg.ax = 0
...
SUB BDatenAendern
  ...
  '$STATIC
  DrawWindow 41 - INT(48 / 2), 13 - INT(14 / 2), 48, 14, 15, 1, 1, "Benutzerdaten ändern"
  COLOR 15, 1
  LOCATE 8, 21
  PRINT "Benutzername:";
  LOCATE 9, 21
  ...
  DO
	...
	ELSE
	  ...
	  NEXT i
	  IF RTRIM$(temp1) = "" THEN
	    errormsg = "Der Name des Benutzers muß min. 1 Zeichen lang sein.;"
	    ERROR 100
	    aktiv = 1
	  END IF
	END IF
	...
	ELSE
	  IF LEN(temp2) < 6 THEN
	    errormsg = "Das Passwort muß mindestens 6 Zeichen lang sein.;"
	    ERROR 100
	    temp2 = ""
	    aktiv = 2
	  ELSE
	...
	ELSE
	  IF NOT temp2 = temp3 THEN
	    errormsg = "Dei beiden eingegebenen Passwörter müssen gleich sein.;"
	    ERROR 100
	    temp2 = ""
	    temp3 = ""
	    aktiv = 2
	...
	COLOR 15, 3
	Center 25, STRING$(80, " ")
	Center 25, CHR$(27) + " " + CHR$(26) + " = Schaltfläche aktivieren, [ENTER] = bestätigen, [TAB] = weiter"
  ...
  IF NOT (abbrkey = KEYESC% OR abutton = 2) THEN
    ...
    COLOR 15, 3
    Center 1, STRING$(80, " ")
    Center 1, "Toxic Brain Coach 1.7ß - " + LTRIM$(RTRIM$(benutzer(auser).username))
  END IF
END SUB
...
SUB BenutzerErfassen
  ...
  IF NOT (abbrkey = KEYESC% OR abutton = 2) THEN
    ...
    COLOR 15, 3
    Center 1, STRING$(80, " ")
    Center 1, "Toxic Brain Coach 1.7ß - " + LTRIM$(RTRIM$(benutzer(user).username))
  ELSE
    user = user - 1
  END IF
END SUB
...
SUB BenutzerLaden
  ...
  COLOR 15, 3
  Center 25, STRING$(80, " ")
  Center 25, CHR$(25) + CHR$(24) + ", [BILD" + CHR$(25) + "]/[BILD" + CHR$(24) + "], [ENDE]/[POS1] = Benutzer auswählen. [ENTER]/[TAB] = weiter"
  ...
  IF NOT tusername = SPACE$(40) THEN
    ...
    COLOR 15, 3
    Center 25, STRING$(80, " ")
    Center 25, "Bitte das Passwort für den Benutzer eingeben. [ENTER] = bestätigen"
	...
	i = i - benutzer(auser).lastlesson + GetDayNr%
      END IF
      IF i > 5 THEN OkMsg "Sie haben seit" + STR$(i) + " Tage nicht gelernt.; Das ist viel zu selten.;Sie sollten min. alle 5 Tage üben;"
      COLOR 15, 3
      Center 1, STRING$(80, " ")
      Center 1, "Toxic Brain Coach 1.7ß - " + LTRIM$(RTRIM$(benutzer(auser).username))
    END IF
...
SUB Benutzerverwaltung
  ...
  itemdesc(1) = "Stammdaten für neuen Benutzer aufnehmen"
  itemstate(1) = 1
  menuitem(2) = "~B~enutzer laden"
  itemdesc(2) = "Einen bereits vorhandenen Benutzer laden"
  itemstate(2) = 1
  menuitem(3) = "Benutzer~d~aten ändern"
  itemdesc(3) = "Benutzername oder Passwort ändern"
  itemstate(3) = 1
  menuitem(4) = "Benutzer au~f~lösen"
  itemdesc(4) = "Nicht mehr benötigte Benutzer als aufgelöst markieren"
  itemstate(4) = 1
  menuitem(5) = "~Z~urück"
  itemdesc(5) = "Zum Hauptmenü zurückkehren"
  itemstate(5) = 1
  aktivitem = 1
  DO
  ...
  DO
	...
	ELSE
	  ...
	  IF j = 0 THEN
	    aktiv = 2
	  ELSE
	    errormsg = "Die Zahl der öffnenden Klammern muß der der schließenden entsprechen"
	    ERROR 100
	  END IF
	END IF
      CASE 2
...
SUB CreateMenu (menutitle AS STRING, items AS INTEGER, menuitem() AS STRING, itemstate() AS INTEGER, itemdesc() AS STRING, aktivitem AS INTEGER)
  ...
  PRINT "Bitte wählen Sie "; CHR$(25); CHR$(24);
  COLOR 15, 3
  Center 25, STRING$(80, " ")
...
SUB MainMenu
  ...
  itemdesc(1) = "Neue Benutzer erfassen, vorhandene laden und auflösen"
  itemstate(1) = 1
  menuitem(2) = "~V~okabeln..."
  itemdesc(2) = "Vokabeln eingeben, anzeigen/ändern und abfragen"
  itemstate(2) = 1
  menuitem(3) = "~S~tatistik"
  itemdesc(3) = "Leistungsdiagramm und ähnliches"
  itemstate(3) = 1
  menuitem(4) = "S~p~iel"
  itemdesc(4) = CHR$(34) + "Galgenmännchen" + CHR$(34) + " spielen"
  itemstate(4) = 1
  menuitem(5) = "~O~ptionen..."
  itemdesc(5) = "Sound- und Farbeinstellungen ändern"
  itemstate(5) = 1
  menuitem(6) = "Programm~e~nde"
  itemdesc(6) = "Toxic Brain Coach 1.7ß beenden"
  itemstate(6) = 1
  aktivitem = 1
  DO
...
SUB Spiel
  DrawWindow 41 - INT(72 / 2), 13 - INT(20 / 2), 72, 20, 15, 1, 1, CHR$(34) + "Galgenmännchen" + CHR$(34)
  Warte
END SUB
...
FUNCTION StartMenu%
  ...
  itemdesc(3) = "Toxic Brain Coach 1.7ß beenden"
  itemstate(3) = 1
  aktivitem = 1
  SaveScreen 1
  DO
...
SUB Vokabelliste
  ...
  COLOR 15, 3
  Center 25, STRING$(80, " ")
  Center 25, CHR$(25) + CHR$(24) + ", [BILD" + CHR$(25) + "]/[BILD" + CHR$(24) + "], [ENDE]/[POS1] = Vokabel auswählen. [ENTER]/[TAB] = weiter"
  temp = SelectFromList$(userliste$(), "Vokabeln anzeigen/ändern - Auswahl")
END SUB
...
SUB Vokabeln
  ...
  itemdesc(1) = "Neue Vokabeln für diesen Benutzer eingeben"
  itemstate(1) = 1
  menuitem(2) = "~V~okabel abfragen"
  itemdesc(2) = "Neue Vokabeln aus der Warteliste übernehmen und Abfrage starten"
  itemstate(2) = 1
  menuitem(3) = "Vokabeln ~a~nzeigen/ändern"
  itemdesc(3) = "Alphabetische Vokabelliste anzeigen - ggf. Vokabeln daraus ändern"
  itemstate(3) = 1
	...
	CASE 1
	  ...
	  ELSE
	    ...
	    IF j = 0 THEN
	      aktiv = 2
	    ELSE
	      errormsg = "Die Zahl der öffnenden Klammern muß der Zahl;der schließenden Klammern entsprechen.;"
	      ERROR 100
	    END IF
	  END IF
	CASE 2
